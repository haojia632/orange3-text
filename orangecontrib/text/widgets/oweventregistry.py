...
from orangecontrib.text.widgets.utils import ComboBox, ListEdit, CheckListLayout, asynchronous,QueryBox
...
class OWEventRegistry(OWWidget):
    """ 从Event Registry获取数据 """
    name = 'ER数据'
    priority = 170
    icon = 'icons/File.svg'
